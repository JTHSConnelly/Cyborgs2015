...
Counter* RobotMap::ElevatorCounterBottom = NULL;
DigitalInput* RobotMap::ElevatorSwitchTop = NULL;
DigitalInput* RobotMap::ElevatorSwitchBottom = NULL;
void RobotMap::init() {
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
	LiveWindow* lw = LiveWindow::GetInstance();

	ElevatorSwitchTop = new DigitalInput(1);
	ElevatorSwitchBottom = new DigitalInput(2);
	ElevatorCounterTop = new Counter(ElevatorSwitchTop);
	ElevatorCounterBottom = new Counter(ElevatorSwitchBottom);
	elevatorMotorControl = new CANTalon(10);


	elevatorMotorControl = new CANTalon(9);
	...
	driveTrainFrontLeftSteer = new CANTalon(2);
	driveTrainFrontLeft = new PIDController(0.35, 0.0, 0.0,/* F: 0.0, */ driveTrainFrontLeftPos, driveTrainFrontLeftSteer, 0.02);
